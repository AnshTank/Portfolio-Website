...
import { Send, Mail, Github, Linkedin, User, MessageSquare, Sparkles } from "lucide-react"
...
const ContactSection = () => {
  ...
  return (
    <section id="contact" className="px-4 sm:px-6 py-16 sm:py-24 bg-gradient-to-br from-background via-muted/10 to-background">
              ...
              <CardContent>
                <form onSubmit={handleSubmit} className="space-y-6">
                  ...
                  >
                    ...
                    <Sparkles className={`ml-2 h-4 w-4 ${isSubmitting ? 'animate-spin' : ''}`} />
                  </Button>
                </form>
              </CardContent>
            </Card>
              ...
              <Card className="card-hover border-primary/20 hover:border-primary/40 backdrop-blur-sm">
                ...
                <CardContent className="space-y-4">
                  <div className="flex flex-col gap-4">
                    <Button size="lg" className="pulse-glow group justify-start" asChild>
                      <a href="mailto:anshtank9@gmail.com">
                        <Mail className="mr-3 h-5 w-5 group-hover:animate-bounce" />
                        <div className="text-left">
                          <div className="font-semibold">Email</div>
                          <div className="text-sm opacity-80">anshtank9@gmail.com</div>
                        </div>
                      </a>
                    </Button>
                    <Button variant="outline" size="lg" className="shimmer-effect group justify-start bg-transparent" asChild>
                      <a href="https://github.com/AnshTank" target="_blank" rel="noopener noreferrer">
                    ...
                    <Button variant="outline" size="lg" className="shimmer-effect group justify-start bg-transparent" asChild>
                      <a href="https://www.linkedin.com/in/anshtank9/" target="_blank" rel="noopener noreferrer">
              ...
              <Card className="bg-gradient-to-br from-primary/10 via-accent/5 to-primary/5 border-primary/30 backdrop-blur-sm">
                <CardContent className="p-6">
                  <div className="text-center space-y-3">
                    ...
                    <h3 className="font-semibold gradient-text">Available for Opportunities</h3>
