          ...
          <div className="relative">
            ...
            <div className="relative w-full h-96">
              <div className="absolute inset-0">
                ...
                {skillLayers[activeLayer].skills.map((skill, index) => (
                  ...
                  >
                    ...
                    >
                      ...
                      <div
                        className="text-xs font-mono font-bold mt-1 transition-all duration-300"
                        style={{
                          color: skill.color,
                          transform:
                            hoveredSkill === skill.name
                ...
                <div className="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2">
                  ...
                  <div
                    className="absolute inset-0 w-6 h-6 border border-primary/30 rounded-full animate-ping"
            ...
            <div className="mt-8 text-center space-y-2">
              ...
              <div className="font-mono text-muted-foreground text-xs">
                NEURAL PATHWAYS: {skillLayers[activeLayer].skills.length} ACTIVE
              </div>
            </div>
          </div>
        </div>
